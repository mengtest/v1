 ...
 * @Date: 2019-05-06 15:39:04
 * @LastEditTime: 2019-05-07 11:16:31
 */
...
class BaseDao {
     ...
     * @returns {Promise}
     */
    update(condition, updater, options) {
        return new Promise((resolve, reject) => {
            this.Model.update(condition, updater, options?options:null, (error, results) => {
                if (error) {
